...
$reqq2='index.php?type='.$_GET["type"].'&sel='.$_GET["sel"].'&analys='.$_GET["analys"].'&day='.$_POST["day"].'&month='.$_POST["month"].'&year='.$_POST["year"].'&day2='.$_POST["day2"].'&month2='.$_POST["month2"].'&year2='.$_POST["year2"];
...
print '</select>&nbsp;&nbsp;&nbsp;';
print '<select id="uprav" name="uprav" style="font-family:verdana; font-size:11px">';
print '<option value="0" >Все управления'; 	
