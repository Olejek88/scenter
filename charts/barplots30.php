...
$height=8*40+120;
$graph = new Graph(1200,$height,"auto");
...
$title='Сравнительные анализ удельного потребления тепла';
$graph->title->Set($title);

// Add the plot to the graph
//$graph->img->SetMargin(40,8,33,25);
//----------- title --------------------
$lineplot->value->Show();
